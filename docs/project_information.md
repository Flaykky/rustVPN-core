...
- CLI (TUI) interface
- fully opensource
- 'reversing' of DPI mechanisms(mainly Russian, learn more at (obfuscations.md[obfuscations.md])
- self hosted vpn
...
## ideal reuslt (goal) of project

- tier 1 cryptography 
- cli widget + very comfortable cli interface
- all popular protocols 
- strong obfuscations against dpi 
